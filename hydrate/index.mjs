...
class WegHeader {
    ...
    render() {
        ...
        return (hAsync(hAsync.Fragment, null, hAsync("a", { key: 'd18f70c7d98a95e8bcc05d1f53d9b69f134c3b18', class: "skip-to-content", href: "#", title: SKIP_TO_CONTENT_LABEL, onClick: (event) => this.handleSkipToContent(event) }, SKIP_TO_CONTENT_LABEL), hAsync("header", { key: '6b9d8af46f4a0fbc817373958d6a4e41ada4f4dc', class: {
                header: true,
                'header--fixed': !mobileMenuActive,
                'header--hidden': this.headerHidden && !mobileMenuActive,
                'header--menu-open': mobileMenuActive,
            } }, hAsync("div", { key: 'bea3a55795e50098d8a05759c0830e0665a6881c', class: "header-inner" }, hAsync("div", { key: '775cd2e0e94e780273178a580e9f1931f699df5f', class: "sr-only", "aria-live": "polite", "aria-atomic": "true", "data-weg-sr-live": true }), hAsync("button", { key: 'c1e57a55e6978ba8cbe4c557776d1ab63fd111a9', type: "button", class: "menu-toggle icon-button", "aria-label": mobileMenuActive ? CLOSE_MAIN_NAV_LABEL : OPEN_MAIN_NAV_LABEL, "aria-expanded": mobileMenuActive ? 'true' : 'false', "aria-controls": "weg-header-main-nav", onClick: () => this.toggleMenu() }, mobileMenuActive ? hAsync(CloseIcon, null) : hAsync(HamburgerIcon, null)), hAsync(Logo, { key: 'fbafa2525388d130539f5a1a090fb22b5705b3e0', href: logoHref, src: logoSrc }), hAsync("div", { key: '29acd4621f8be6c67877639aa49f19e4daa395c9', class: "header-actions" }, this.renderCompactAuth(mobileMenuActive ? closeMenu : undefined)), hAsync("div", { key: 'd9d8b0efa3b90d639be73613b116f18f217af2a5', class: "main-nav-panel", id: "weg-header-main-nav", role: mobileMenuActive ? 'dialog' : undefined, "aria-modal": mobileMenuActive ? 'true' : undefined, "aria-label": mobileMenuActive ? MAIN_NAV_LABEL : undefined }, this.renderNav(mobileMenuActive ? closeMenu : undefined))))));
    }
    static get watchers() { return {
        "layout": [{
                "watchLayout": 0
