...
const NAMESPACE = 'weg-shared-layout';
const BUILD = /* weg-shared-layout */ { hotModuleReplacement: false, hydratedSelectorName: "hydrated", slotRelocation: true, state: true, updatable: true};
...
function isMenuGroup(link) {
    return Boolean(link.items?.length);
}
function readNestedItems(raw) {
    return raw.items ?? raw.children;
}
function readLinkTarget(raw) {
...
function normalizeLayoutLink(input, options) {
    ...
    if (isNonEmptyString(href)) {
        const link = { label: label.trim(), href: href.trim() };
...
function normalizeLinks(input, options) {
...
function normalizeHeaderMenu(input) {
    return normalizeLinks(input, { requireHref: false });
}
function findAuthMenuLink(menu, action) {
    for (const item of menu) {
        if (isMenuGroup(item))
            continue;
        if (item.authAction === action)
            return item;
    }
    return null;
}
...
const sharedCss$1 = () => `:host{--weg-breakpoint-sm:640px;--weg-breakpoint-md:960px;--weg-breakpoint-lg:1280px;--weg-breakpoint-xl:1440px}:root,:host{--weg-container-breakpoint-sm:40rem;--weg-container-breakpoint-md:48rem;--weg-container-breakpoint-lg:64rem;--weg-container-breakpoint-xl:80rem;--weg-container-breakpoint-2xl:86rem;--weg-container-max-vw:95vw;--weg-container-padding-inline:1rem}@media (width >= 48rem){:root,:host{--weg-container-padding-inline:2rem}}.container{width:100%;max-width:var(--weg-container-max-vw);margin-inline:auto;padding-inline:var(--weg-container-padding-inline)}@media (width >= 40rem){.container{max-width:min(var(--weg-container-breakpoint-sm), var(--weg-container-max-vw))}}@media (width >= 48rem){.container{max-width:min(var(--weg-container-breakpoint-md), var(--weg-container-max-vw))}}@media (width >= 64rem){.container{max-width:min(var(--weg-container-breakpoint-lg), var(--weg-container-max-vw))}}@media (width >= 80rem){.container{max-width:min(var(--weg-container-breakpoint-xl), var(--weg-container-max-vw))}}@media (width >= 86rem){.container{max-width:min(var(--weg-container-breakpoint-xl), var(--weg-container-max-vw))}}*,*::before,*::after{box-sizing:border-box}:host{display:block;--weg-font-family:ui-sans-serif, system-ui, -apple-system, 'Segoe UI', Roboto, Helvetica, Arial, 'Apple Color Emoji',      'Segoe UI Emoji';--weg-color-accent:#948eeb;--weg-purple-200:#cdcff8}.sr-only{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0, 0, 0, 0);white-space:nowrap;border:0}`;

const wegFooterCss = () => `:host{--weg-breakpoint-sm:640px;--weg-breakpoint-md:960px;--weg-breakpoint-lg:1280px;--weg-breakpoint-xl:1440px}.footer{background:#030712;color:#ffffff;font-family:var(--weg-font-family);font-weight:300}.footer__inner{display:flex;flex-direction:column;align-items:center;gap:1.25rem;padding-block:2rem;padding-inline:0}@media (width >= 960px){.footer__inner{gap:2.25rem;padding-block:3.5rem}}.social{display:flex;align-items:center;justify-content:center;gap:1rem;flex-wrap:wrap;padding:0;margin:0;list-style:none}@media (width >= 960px){.social{gap:1.75rem}}.social__item{padding:0;margin:0}.social__link{width:3rem;height:3rem;display:inline-flex;align-items:center;justify-content:center;border-radius:999rem;background:transparent;color:inherit;text-decoration:none;transition:opacity 150ms ease;outline:none}.social__link:hover{opacity:0.9}.social__link:focus-visible{outline:2px solid rgba(255, 255, 255, 0.9);outline-offset:4px}.social__icon{display:inline-flex;width:3rem;height:3rem}.footer-link{color:#ffffff;font-family:'Open Sans', var(--weg-font-family);font-size:1rem;font-style:normal;font-weight:300;line-height:1.5rem;display:block;width:100%;text-align:center;text-decoration-line:underline;text-decoration-style:solid;text-decoration-skip-ink:none;text-decoration-thickness:auto;text-underline-offset:auto;text-underline-position:from-font;outline:none}@media (width >= 960px){.footer-link{display:inline;width:auto;text-align:left}}.footer-link:hover{opacity:0.9}.footer-link:focus-visible{outline:2px solid rgba(255, 255, 255, 0.9);outline-offset:4px}.legal{width:100%;max-width:860px;text-align:center;font-size:1rem;line-height:1.5rem;display:flex;flex-direction:column;gap:1rem}@media (width >= 960px){.legal{font-size:1.125rem;line-height:1.75rem}}.legal__p{margin:0}.columns{width:100%;display:grid;grid-template-columns:1fr;gap:0.75rem;font-size:1rem;line-height:1.5rem;padding:0;margin:0}.columns__col{display:flex;flex-direction:column;align-items:stretch;width:100%;min-width:0}.columns__col:not(:first-child){gap:2rem;border-top:1px solid rgba(255, 255, 255, 0.35);padding-top:1.5rem;margin-top:1.5rem}.columns__links{display:flex;flex-direction:column;align-items:stretch;gap:0.75rem;width:100%;min-width:0;text-align:center;list-style:none;padding:0}@media (width >= 640px){.columns{grid-template-columns:repeat(3, minmax(0, 1fr));gap:1.5rem 3rem;font-size:1.125rem;line-height:1.75rem}.columns__col:not(:first-child){gap:0;border-left:1px solid rgba(255, 255, 255, 0.35);padding-left:1.5rem;margin-top:0;padding-top:0;border-top:none}.columns__col:not(:last-child){padding-right:1.5rem}.footer-link{display:inline;width:auto;text-align:left}.columns__links{align-items:flex-start;text-align:left}}@media (width >= 960px){.columns{display:flex;flex-direction:row;align-items:stretch;justify-content:center;gap:0}.columns__col{flex:1 1 0;flex-direction:row;align-items:stretch}.columns__col:not(:first-child){gap:0}.columns__links{flex:1;align-items:flex-start;text-align:left}}`;
...
function isValidSocialPlatform(value) {
...
function linkOpensNewTab(link) {
    if (link.target === '_blank')
        return true;
    return link.href ? isExternalHref(link.href) : false;
}
function linkTarget(link) {
    if (link.target)
        return link.target;
    return linkOpensNewTab(link) ? '_blank' : undefined;
}
function linkRel(link) {
    return linkOpensNewTab(link) ? 'noreferrer noopener' : undefined;
}
...
class WegFooter {
     ...
     *     "menu": [[{ "label": "About Us", "href": "/about" }]],
     *     "credits": "...",
     *     "copyright": "..."
     *   }
     * }
    ...
    renderLegalText() {
        ...
        if (!credits && !copyright)
            return null;
        return (hAsync("div", { class: "legal" }, credits ? hAsync("p", { class: "legal__p" }, credits) : null, copyright ? hAsync("p", { class: "legal__p" }, copyright) : null));
    }
    renderSocialLinks() {
        const links = this.resolved.social;
        if (links.length === 0)
            return null;
        return (hAsync("menu", { class: "social" }, links.map((l) => (hAsync("li", { class: "social__item", key: l.platform }, hAsync("a", { class: "social__link", href: l.href, "aria-label": l.platform, target: isExternalHref(l.href) ? '_blank' : undefined, rel: isExternalHref(l.href) ? 'noreferrer noopener' : undefined }, hAsync("span", { class: "social__icon", "aria-hidden": "true" }, hAsync(SocialIcon, { platform: l.platform }))))))));
    }
    renderMenu() {
    ...
    static get style() { return sharedCss$1() + wegFooterCss(); }
...
/**
 * JS media-query strings aligned with `src/styles/breakpoints.css`.
 */
const WEG_MD_MEDIA_QUERY = '(width >= 960px)';
/** Primary input can hover (excludes most touch-only profiles). */
const WEG_HOVER_CAPABLE_MEDIA_QUERY = '(hover: hover)';
...
function parseCurrentLocation(currentPath) {
...
function isNavLinkActive(currentPath, href, mode = 'prefix') {
    if (!currentPath?.trim() || !href?.trim())
        return false;
    ...
    if (current.pathname === parsedHref.pathname)
        return true;
    return current.pathname.startsWith(`${parsedHref.pathname}/`);
}
function getNavLinkMatchScore(currentPath, href, mode = 'prefix') {
    if (!isNavLinkActive(currentPath, href, mode))
        return 0;
    const parsedHref = parseNavHref(href);
    if (!parsedHref)
        return 0;
...
function resolveAriaCurrentNavKey(menu, currentPath, shouldExclude) {
    ...
    for (const item of menu) {
        if (item.items?.length) {
            for (const child of item.items) {
                if (!child.href || shouldExclude?.(child))
                    continue;
        ...
        if (!item.href || shouldExclude?.(item))
            continue;
...
function normalizeAccountBase(input) {
    const base = input?.trim() || DEFAULT_ACCOUNT_HOME;
    return base.replace(/\/$/, '');
}
function accountPath(accountHome, path) {
    const normalizedPath = path.startsWith('/') ? path : `/${path}`;
    return `${normalizeAccountBase(accountHome)}${normalizedPath}`;
}
function buildSignedInMenu(accountHome) {
    return [
...
function isSignInLink(link, accountHome) {
    if (link.authAction === 'sign-in')
        return true;
    if (link.authAction === 'sign-out')
        return false;
...
function isManageAccountLink(link, accountHome) {
    if (link.label.trim().toLowerCase() === 'manage account')
        return true;
...
function normalizeHeaderData(input) {
    const root = (input && typeof input === 'object' ? input : {});
...
function SignInIcon() {
    return (hAsync("svg", { viewBox: "0 0 448 512", width: "20", height: "20", "aria-hidden": "true", focusable: "false" }, hAsync("path", { d: "M304 128a80 80 0 1 0 -160 0 80 80 0 1 0 160 0zM96 128a128 128 0 1 1 256 0A128 128 0 1 1 96 128zM49.3 464l349.5 0c-8.9-63.3-63.3-112-129-112l-91.4 0c-65.7 0-120.1 48.7-129 112zM0 482.3C0 383.8 79.8 304 178.3 304l91.4 0C368.2 304 448 383.8 448 482.3c0 16.4-13.3 29.7-29.7 29.7L29.7 512C13.3 512 0 498.7 0 482.3z", fill: "currentColor" })));
}
function SignOutIcon() {
    return (hAsync("svg", { viewBox: "0 0 26 24", width: "26", height: "24", "aria-hidden": "true", focusable: "false", fill: "none" }, hAsync("path", { d: "M19.6667 6.33333L25 11.6667L19.6667 17M25 11.6667H6.33333M14.3333 17V18.3333C14.3333 19.3942 13.9119 20.4116 13.1618 21.1618C12.4116 21.9119 11.3942 22.3333 10.3333 22.3333H5C3.93913 22.3333 2.92172 21.9119 2.17157 21.1618C1.42143 20.4116 1 19.3942 1 18.3333V5C1 3.93913 1.42143 2.92172 2.17157 2.17157C2.92172 1.42143 3.93913 1 5 1H10.3333C11.3942 1 12.4116 1.42143 13.1618 2.17157C13.9119 2.92172 14.3333 3.93913 14.3333 5V6.33333", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" })));
}
function FindJobIcon() {
    return (hAsync("svg", { xmlns: "http://www.w3.org/2000/svg", width: "20", height: "20", viewBox: "0 0 20 20", fill: "none" }, hAsync("path", { d: "M19 19L13 13M15 8C15 8.91925 14.8189 9.82951 14.4672 10.6788C14.1154 11.5281 13.5998 12.2997 12.9497 12.9497C12.2997 13.5998 11.5281 14.1154 10.6788 14.4672C9.82951 14.8189 8.91925 15 8 15C7.08075 15 6.1705 14.8189 5.32122 14.4672C4.47194 14.1154 3.70026 13.5998 3.05025 12.9497C2.40024 12.2997 1.88463 11.5281 1.53284 10.6788C1.18106 9.82951 1 8.91925 1 8C1 6.14348 1.7375 4.36301 3.05025 3.05025C4.36301 1.7375 6.14348 1 8 1C9.85652 1 11.637 1.7375 12.9497 3.05025C14.2625 4.36301 15 6.14348 15 8Z", stroke: "black", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" })));
}
function DashboardIcon() {
    return (hAsync("svg", { xmlns: "http://www.w3.org/2000/svg", width: "18", height: "18", viewBox: "0 0 18 18", fill: "none" }, hAsync("path", { d: "M1.29289 1.29289C1.10536 1.48043 1 1.73478 1 2V4C1 4.26522 1.10536 4.51957 1.29289 4.70711C1.48043 4.89464 1.73478 5 2 5H16C16.2652 5 16.5196 4.89464 16.7071 4.70711C16.8946 4.51957 17 4.26522 17 4V2C17 1.73478 16.8946 1.48043 16.7071 1.29289C16.5196 1.10536 16.2652 1 16 1H2C1.73478 1 1.48043 1.10536 1.29289 1.29289Z", stroke: "black", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" }), hAsync("path", { d: "M1.29289 9.29289C1.10536 9.48043 1 9.73478 1 10V16C1 16.2652 1.10536 16.5196 1.29289 16.7071C1.48043 16.8946 1.73478 17 2 17H8C8.26522 17 8.51957 16.8946 8.70711 16.7071C8.89464 16.5196 9 16.2652 9 16V10C9 9.73478 8.89464 9.48043 8.70711 9.29289C8.51957 9.10536 8.26522 9 8 9H2C1.73478 9 1.48043 9.10536 1.29289 9.29289Z", stroke: "black", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" }), hAsync("path", { d: "M13.2929 9.29289C13.1054 9.48043 13 9.73478 13 10V16C13 16.2652 13.1054 16.5196 13.2929 16.7071C13.4804 16.8946 13.7348 17 14 17H16C16.2652 17 16.5196 16.8946 16.7071 16.7071C16.8946 16.5196 17 16.2652 17 16V10C17 9.73478 16.8946 9.48043 16.7071 9.29289C16.5196 9.10536 16.2652 9 16 9H14C13.7348 9 13.4804 9.10536 13.2929 9.29289Z", stroke: "black", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" })));
}
function HamburgerIcon() {
    return (hAsync("svg", { viewBox: "0 0 24 24", width: "28", height: "28", "aria-hidden": "true", focusable: "false", fill: "none" }, hAsync("path", { d: "M4 7h16M4 12h16M4 17h16", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round" })));
}
function CloseIcon() {
    return (hAsync("svg", { viewBox: "0 0 24 24", width: "24", height: "24", "aria-hidden": "true", focusable: "false", fill: "none" }, hAsync("path", { d: "M6 6l12 12M18 6L6 18", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round" })));
}
function ToggleIcon({ expanded }) {
    return (hAsync("span", { class: "toggle-icon", "aria-hidden": "true" }, expanded ? (hAsync("svg", { viewBox: "0 0 24 24", width: "14", height: "14", fill: "none" }, hAsync("path", { d: "M6 12h12", stroke: "currentColor", "stroke-width": "2.5", "stroke-linecap": "round" }))) : (hAsync("svg", { viewBox: "0 0 24 24", width: "14", height: "14", fill: "none" }, hAsync("path", { d: "M12 6v12M6 12h12", stroke: "currentColor", "stroke-width": "2.5", "stroke-linecap": "round" })))));
}
function Logo({ href, src }) {
    return (hAsync("a", { class: "logo-link", href: href, "aria-label": "Home" }, hAsync("img", { class: "logo", src: src, alt: "Warwick Employment Group logo", width: "225", height: "83" })));
}
class WegHeader {
    constructor(hostRef) {
        registerInstance(this, hostRef);
        this.wegAuthClick = createEvent(this, "wegAuthClick");
    }
    /**
     * Layout payload, supplied by the host application.
     *
    ...
    hoverOpenEnabled = false;
    desktopMediaQuery;
    hoverCapableMediaQuery;
    resolve() {
        if (this.layout === undefined || this.layout === null) {
     ...
     */
    updateHoverDropdownEnabled() {
        const enabled = Boolean(this.desktopMediaQuery?.matches && this.hoverCapableMediaQuery?.matches);
    ...
    announceSubmenuCollapsed(label) {
    ...
    getDropdownPanelId(label) {
        return `weg-header-dropdown-${label.trim().toLowerCase().replace(/\s+/g, '-')}`;
    }
    handleDropdownPointerEnter(label) {
        if (!this.hoverOpenEnabled)
            return;
        this.openDropdownMenu(label);
    }
    ...
    handleDropdownPanelPointerEnter(label) {
        if (!this.hoverOpenEnabled)
            return;
        this.cancelScheduledDropdownClose();
        this.openDropdownMenu(label);
    }
    handleDropdownPanelPointerLeave(event) {
        if (!this.hoverOpenEnabled)
            return;
        const related = event.relatedTarget;
    ...
    handleDropdownTriggerClick(event, label) {
        event.stopPropagation();
        this.cancelScheduledDropdownClose();
        this.toggleDropdown(label);
    }
    handleDropdownFocusOut(event, label) {
        const related = event.relatedTarget;
        const container = event.currentTarget;
        if (related && container.contains(related))
            return;
    ...
    handleDropdownTriggerKeyDown(event, label, itemEl) {
    ...
    focusFirstDropdownLink(itemEl) {
        this.focusDropdownLink(itemEl, 0);
    }
    getDropdownContainer(label) {
    ...
    closeDropdownAndFocusTrigger(labelOrContainer) {
        const container = typeof labelOrContainer === 'string'
            ? this.getDropdownContainer(labelOrContainer)
            : labelOrContainer;
        const trigger = container?.querySelector('.nav-dropdown__trigger');
        const label = typeof labelOrContainer === 'string'
            ? labelOrContainer
    ...
    handleDropdownLinkKeyDown(event, container) {
        const links = this.getDropdownLinks(container);
    ...
    findSignInLink(menu) {
        ...
        for (const item of menu) {
            if (!isMenuGroup(item) && isSignInLink(item, accountHome))
                return item;
        }
        return null;
    }
    getManageAccountLabel() {
    ...
    isNavItemActive(href, mode) {
        return isNavLinkActive(this.currentPath ?? '', href, mode);
    }
    resolveAriaCurrentHref() {
        const accountHome = this.getAccountHome();
        return resolveAriaCurrentNavKey(this.getActiveMenu(), this.currentPath ?? '', (item) => this.shouldExcludeFromNavActive(item, accountHome));
    }
    isAriaCurrentHref(href, ariaCurrentKey) {
        return isAriaCurrentNavHref(href, ariaCurrentKey);
    }
    renderIconNavLink(link, Icon, className, onNavigate, ariaCurrentHref = null) {
        const active = this.isNavItemActive(link.href, 'prefix');
        const ariaCurrent = this.isAriaCurrentHref(link.href, ariaCurrentHref);
        return (hAsync("li", { class: "main-nav__item main-nav__item--auth", key: link.label }, hAsync("a", { class: {
                'sign-in-link': true,
                [className]: true,
                'nav-link--active': active,
            }, href: link.href, "aria-current": ariaCurrent ? 'page' : undefined, onClick: () => onNavigate?.() }, hAsync(Icon, null), link.label)));
    }
    renderFlatNavLink(link, onNavigate, ariaCurrentHref = null) {
        const active = this.isNavItemActive(link.href, 'prefix');
        const ariaCurrent = this.isAriaCurrentHref(link.href, ariaCurrentHref);
        return (hAsync("li", { class: "main-nav__item", key: link.label }, hAsync("a", { class: {
                'nav-link': true,
                'nav-link--active': active,
            }, href: link.href, "aria-current": ariaCurrent ? 'page' : undefined, onClick: () => onNavigate?.() }, link.label)));
    }
    renderMenuGroup(item, onNavigate, ariaCurrentHref = null) {
        ...
        return (hAsync("li", { class: "main-nav__item main-nav__item--dropdown", key: item.label }, hAsync("div", { class: "nav-dropdown", onMouseEnter: () => this.handleDropdownPointerEnter(item.label), onMouseLeave: (event) => this.handleDropdownPointerLeave(event), onFocusout: (event) => this.handleDropdownFocusOut(event, item.label) }, hAsync("button", { type: "button", class: {
                'nav-dropdown__trigger': true,
                'nav-dropdown__trigger--open': isOpen,
                'nav-dropdown__trigger--active': groupActive,
            }, "aria-expanded": isOpen ? 'true' : 'false', "aria-haspopup": "true", "aria-controls": panelId, id: `${panelId}-trigger`, onClick: (event) => this.handleDropdownTriggerClick(event, item.label), onKeyDown: (event) => {
                const container = event.currentTarget.closest('.nav-dropdown');
                this.handleDropdownTriggerKeyDown(event, item.label, container);
            } }, hAsync("span", { class: "nav-dropdown__label" }, item.label), hAsync(ToggleIcon, { expanded: isOpen })), isOpen ? (hAsync("div", { class: "nav-dropdown__panel", id: panelId, role: "region", "aria-labelledby": `${panelId}-trigger`, onMouseEnter: () => this.handleDropdownPanelPointerEnter(item.label), onMouseLeave: (event) => this.handleDropdownPanelPointerLeave(event) }, hAsync("div", { class: "nav-dropdown__accent" }, hAsync("ul", { class: "nav-dropdown__links" }, items.map((child, index) => {
            ...
            return (hAsync("li", { key: `${item.label}:${child.label}` }, hAsync("a", { class: {
                    'nav-dropdown__link': true,
                    'nav-dropdown__link--active': childActive,
                }, href: child.href, "aria-label": positionLabel, "aria-current": ariaCurrent ? 'page' : undefined, onClick: () => onNavigate?.(), onKeyDown: (event) => {
                    const dropdownContainer = event.currentTarget.closest('.nav-dropdown');
                    this.handleDropdownLinkKeyDown(event, dropdownContainer);
                } }, child.label)));
        }))))) : null)));
    }
    handleAuthClick(event, action, _href, onNavigate) {
    ...
    renderManageAccountAnchor(onNavigate, iconOnly = false, ariaCurrentHref = null) {
        ...
        return (hAsync("a", { class: {
                ...
                'icon-button': iconOnly,
                'nav-link--active': active,
            }, href: href, "aria-label": label, "aria-current": ariaCurrent ? 'page' : undefined, onClick: () => onNavigate?.() }, hAsync(SignInIcon, null), !iconOnly ? label : null, iconOnly ? hAsync("span", { class: "sr-only" }, label) : null));
    }
    renderNavItem(item, onNavigate, ariaCurrentHref = null) {
        const accountHome = this.getAccountHome();
        if (isMenuGroup(item)) {
            return this.renderMenuGroup(item, onNavigate, ariaCurrentHref);
        }
        if (isSignOutLink(item)) {
            return (hAsync("li", { class: "main-nav__item main-nav__item--auth", key: "sign-out" }, this.renderAuthControl({ link: item, action: 'sign-out', onNavigate })));
        }
    ...
    renderNav(onNavigate) {
        ...
        return (hAsync("nav", { class: "main-nav", "aria-label": MAIN_NAV_LABEL }, hAsync("ul", { class: "main-nav__list" }, this.getActiveMenu().map((item) => this.renderNavItem(item, onNavigate, ariaCurrentHref)))));
    }
    ...
    handleSkipToContent(event) {
        ...
        const heading = (contentRoot instanceof HTMLElement ? contentRoot.querySelector('h1') : null) ??
    ...
    render() {
        ...
        return (hAsync("div", { key: '7de9456349faccdc02caa1458af12361c509881f', class: "weg-header-shell" }, hAsync("a", { key: 'a2c27545363d362bbdeb80d830b0b757a1090585', class: "skip-to-content", href: "#", title: SKIP_TO_CONTENT_LABEL, onClick: (event) => this.handleSkipToContent(event) }, SKIP_TO_CONTENT_LABEL), hAsync("header", { key: '592fccf957ad7e29f3113143e853a2d0a0d84b25', class: {
                header: true,
                'header--fixed': !mobileMenuActive,
                'header--hidden': this.headerHidden && !mobileMenuActive,
                'header--menu-open': mobileMenuActive,
            } }, hAsync("div", { key: 'b36223997721eb185813831b34fe59efeb8d55c7', class: "header-inner" }, hAsync("div", { key: '032b4e9682d9a271a8be93e0f11125a1ee673680', class: "sr-only", "aria-live": "polite", "aria-atomic": "true", "data-weg-sr-live": true }), hAsync("button", { key: 'c74ea7c3cb31fb21aa7d976a615487d7121739eb', type: "button", class: "menu-toggle icon-button", "aria-label": mobileMenuActive ? CLOSE_MAIN_NAV_LABEL : OPEN_MAIN_NAV_LABEL, "aria-expanded": mobileMenuActive ? 'true' : 'false', "aria-controls": "weg-header-main-nav", onClick: () => this.toggleMenu() }, mobileMenuActive ? hAsync(CloseIcon, null) : hAsync(HamburgerIcon, null)), hAsync(Logo, { key: '0107f366b4e69e7ceddc05715b06a110bb9f22bc', href: logoHref, src: logoSrc }), hAsync("div", { key: '6e273b0ea6b4f9f8ee4533af7b6df1c10a91ed9b', class: "header-actions" }, this.renderCompactAuth(mobileMenuActive ? closeMenu : undefined)), hAsync("div", { key: '5c06b9fa77e50e9357bc6f5d27805c895ec4ea0c', class: "main-nav-panel", id: "weg-header-main-nav", role: mobileMenuActive ? 'dialog' : undefined, "aria-modal": mobileMenuActive ? 'true' : undefined, "aria-label": mobileMenuActive ? MAIN_NAV_LABEL : undefined }, this.renderNav(mobileMenuActive ? closeMenu : undefined))))));
    }
    static get watchers() { return {
        "layout": [{
                "watchLayout": 0
    ...
    static get style() { return sharedCss() + wegHeaderCss(); }
    static get cmpMeta() { return {
        "$flags$": 521,
        "$tagName$": "weg-header",
        "$members$": {
            "layout": [1],
            "signedIn": [516, "signed-in"],
            "userName": [1, "user-name"],
            "accountBaseUrl": [1, "account-base-url"],
            "currentPath": [1, "current-path"],
            "resolved": [32],
            "menuOpen": [32],
            "openDropdown": [32],
            "headerHidden": [32]
        ...
        "$lazyBundleId$": "-",
        "$attrsToReflect$": [["signedIn", "signed-in"]]
    }; }
}
