...
import type { LayoutData, LayoutLink } from '../../types/layout-data';
import { isNonEmptyString, normalizeMenu, parseJsonProp } from '../../utils/layout';

type FooterLink = LayoutLink;
